...
{ path : 'frame', loadChildren: () => import('./frame/frame.module').then(m => m.FrameModule), canActivate: [AuthGuard] } , 
{ path : 'motor', loadChildren: () => import('./motor/motor.module').then(m => m.MotorModule), canActivate: [AuthGuard] } , 
{ path : 'catalog', loadChildren: () => import('./catalog/catalog.module').then(m => m.CatalogModule), canActivate: [AuthGuard] } , 
{ path : 'gpsearchitem', loadChildren: () => import('./gpsearchitem/gpsearchitem.module').then(m => m.GpsearchitemModule), canActivate: [AuthGuard] } , 
];
